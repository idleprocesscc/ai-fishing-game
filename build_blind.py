...
def build():
    ...
    expansion_src = (HERE / "world_expansion.py").read_text(encoding="utf-8")
    ...
    bootstrap = (
        "import sys, types\n"
        "_exp = types.ModuleType('world_expansion')\n"
        "exec(" + repr(expansion_src) + ", _exp.__dict__)\n"
        "sys.modules['world_expansion'] = _exp\n"
